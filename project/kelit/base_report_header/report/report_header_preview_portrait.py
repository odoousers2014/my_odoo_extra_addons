...
class report_header_portrait(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        super(report_header_portrait, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.header.preview.portrait', 'res.header', 'addons/base_report_header/report/report_header_preview_portrait.rml', parser=report_header_portrait, header="default portrait")
