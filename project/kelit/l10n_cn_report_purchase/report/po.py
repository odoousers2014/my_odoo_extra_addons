...
class po(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        super(po, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.l10n.cn.po', 'purchase.order', 'addons/l10n_cn_report_purchase/report/po.rml', parser=po, header='external portrait')
