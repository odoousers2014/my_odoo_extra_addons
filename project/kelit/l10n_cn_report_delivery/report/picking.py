...
report_sxw.report_sxw('report.stock.picking.list.kelit','stock.picking.out','addons/l10n_cn_report_delivery/report/picking.rml',parser=picking, header="external portrait")
