...
class contract(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        ...
        self.localcontext.update({
            ...
            'tag':self.tag,
            'get_sale_discount':self._get_sale_discount,
        })
    #jon get sale discount
    def _get_sale_discount(self,sol_id):
        cr=self.cr
        uid=1
        discount=0.0
        ...
        shop_price = line.product_id.shop_price
        if shop_price:
            discount= line.price_unit / shop_price
...
report_sxw.report_sxw('report.l10n.cn.contract', 'sale.order', 'addons/l10n_cn_report_sale/report/contract.rml', parser=contract, header='external portrait')
