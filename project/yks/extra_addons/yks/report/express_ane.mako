...
<div style="position:relative;  top:0px; left:0px; width:200px; height:20px;">
    ...
    <h2 style="position:absolute; top:190px; left:180px; width:380px;  background:#FFF; text-align:left;">${ get_user_phone(o)  }</h2>
    ...
    <h2 style="position:absolute; top:100px;  left:700px; width:380px;  background:#FFF; text-align:left;">${ get_receive_address(o)}</h2>

    <h2 style="position:absolute; top:190px; left:700px; width:380px;  background:#FFF; text-align:left;">${ get_receive_phone(o)} </h2>
    
    <h2 style="position:absolute; top:320px; left:180px; width:500px;  background:#FFF; text-align:left;">${get_user_signature(o)}</h2>
    <h2 style="position:absolute; top:350px; left:180px; width:500px;  background:#FFF; text-align:left;">${ time.strftime('%Y-%m-%d') }</h2>
    
    <h2 style="position:absolute; top:350px;   left:750px; width:500px;  background:#FFF; text-align:left;">${ print_num(o) }</h2>
